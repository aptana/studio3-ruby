 ...
 */
public interface IRubyLineBreakpoint extends IRubyBreakpoint, ILineBreakpoint
{

	/**
	 * Returns whether this breakpoint supports a conditional expression. Conditional breakpoints only suspend when
	...
	/**
	 * Get the full path to the underlying file. Works for resources and external files.
	 * @return
